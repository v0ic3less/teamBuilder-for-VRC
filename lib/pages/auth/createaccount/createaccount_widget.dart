                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Theme(
                                          ...
                                          child: CheckboxListTile(
                                            ...
                                            title: Text(
                                              'I am 13 years old or older and I agree to the Terms of Service.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'CREATEACCOUNT_CONTINUE_WITH_GOOGLE_BTN_O');
                                            logFirebaseEvent('Button_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            final user = await authManager
                                          ...
                                          : Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: true
                                                    ...
                                                    : () async {
                                                        logFirebaseEvent(
                                                            'CREATEACCOUNT_CONTINUE_WITH_APPLE_BTN_ON');
                                                        logFirebaseEvent(
                                                            'Button_auth');
                                                        GoRouter.of(context)
                                                            .prepareAuthEvent();
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CREATEACCOUNT_RichText_yhlvx583_ON_TAP');
                                              logFirebaseEvent(
