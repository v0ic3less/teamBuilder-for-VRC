...
class ChatThreadComponentModel
  ...
  // Stores action output result for [Custom Action - findBlockedUsers] action in chat_ThreadComponent widget.
  List<DocumentReference>? blockedUsers;
  // Stores action output result for [Backend Call - Read Document] action in chat_ThreadComponent widget.
  UsersRecord? firstBlockedUser;
  // Stores action output result for [Backend Call - Read Document] action in chat_ThreadComponent widget.
  UsersRecord? secondBlockedUser;
  // Stores action output result for [Backend Call - Read Document] action in chat_ThreadComponent widget.
  UsersRecord? thirdBlockedUser;
