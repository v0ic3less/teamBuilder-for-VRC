...
import 'signature_events_model.dart';
export 'signature_events_model.dart';

class SignatureEventsWidget extends StatefulWidget {
  const SignatureEventsWidget({
    super.key,
  ...
  @override
  State<SignatureEventsWidget> createState() => _SignatureEventsWidgetState();
}

class _SignatureEventsWidgetState extends State<SignatureEventsWidget> {
  late SignatureEventsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignatureEventsModel());
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SIGNATURE_EVENTS_externalLink_ICN_ON_TAP');
                                        logFirebaseEvent(
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SIGNATURE_EVENTS_COMP_mapPin_ICN_ON_TAP');
                                        logFirebaseEvent(
                                            'IconButton_alert_dialog');
                                        await showDialog(
                                          barrierColor: const Color(0x880F1316),
