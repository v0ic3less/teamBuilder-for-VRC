...
import 'match_finished_model.dart';
export 'match_finished_model.dart';

class MatchFinishedWidget extends StatefulWidget {
  const MatchFinishedWidget({super.key});

  @override
  State<MatchFinishedWidget> createState() => _MatchFinishedWidgetState();
}

class _MatchFinishedWidgetState extends State<MatchFinishedWidget> {
  late MatchFinishedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchFinishedModel());
