...
import 'tournament_rankings_model.dart';
export 'tournament_rankings_model.dart';
...
class _TournamentRankingsWidgetState extends State<TournamentRankingsWidget>
  ...
  late TournamentRankingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TournamentRankingsModel());
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'TOURNAMENT_RANKINGS_close_rounded_ICN_ON');
                                        logFirebaseEvent(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              ...
                                              return ListView.builder(
                                                ...
                                                itemBuilder:
                                                    (context, ranksListIndex) {
                                                  final ranksListItem =
                                                      ranksList[ranksListIndex];
                                                  return Row(
                                                    mainAxisSize:
                                                        MainAxisSize.max,
                                                    mainAxisAlignment:
