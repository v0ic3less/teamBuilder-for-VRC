...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF3575A);
  late Color secondary = const Color(0xFFFE9199);
  ...
  late Color accent1 = const Color(0xFFFFC8CB);
  late Color accent2 = const Color(0x4CFF6A73);
  late Color accent3 = const Color(0xFFCCE7FF);
  late Color accent4 = const Color(0xB29C9C9C);
  ...
  late Color info = const Color(0xFF303030);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF365FAB);
  late Color secondary = const Color(0xFF567EC3);
  late Color tertiary = const Color(0xFF091B3F);
  late Color alternate = const Color(0xFF2C323B);
  late Color primaryText = const Color(0xFFF6F6F6);
  late Color secondaryText = const Color(0xFFDFDFDF);
  late Color primaryBackground = const Color(0xFF151923);
  late Color secondaryBackground = const Color(0xFF060608);
  late Color accent1 = const Color(0xFF2243AB);
  late Color accent2 = const Color(0xFF761212);
  late Color accent3 = const Color(0xFF151618);
  late Color accent4 = const Color(0xFF2B333B);
  late Color success = const Color(0xFF6BBD78);
  late Color warning = const Color(0xFFEC9C4B);
  late Color error = const Color(0xFFF83B46);
  late Color info = const Color(0xFFC0C0C0);
}
